...
* To reduce the size of the payload being sent, the server can broadcast the delta of state change since last broadcast
  * Need to periodically send full state in case message was lost in transmission. How frequent to send full state depends on what is the worst case scenario of delayed updates.
