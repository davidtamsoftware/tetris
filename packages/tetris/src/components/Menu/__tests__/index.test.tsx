...
xdescribe("<Menu />", () => {
    ...
    it("should trigger an action when the user select a menu option that is a leaf node");
    it("should trigger an action when the user goes back on the root menu");
})